...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordEncoderInterface $userPasswordEncoder, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user->setActivationToken("Dy06bx6QRyD3VFjJJg1NB8VrqDh1ZDmx0jT5Eyt6x4o");
...
$sid = 'AC3c9a93dad947a221aff13ffe8b19ae3b';
$auth_token = 'c4f388d5203f6b60b58e18c7ea2a7e65';
// In production, these should be environment variables. E.g.:
// $auth_token = $_ENV["TWILIO_AUTH_TOKEN"]
// A Twilio number you own with SMS capabilities
$twilio_number = "+16205269903";
...
/************************************* */
           /* $this->twilio->messages->create("+21699114761", [
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('gamex20222@gmail.com', 'Art_Plus'))
                    ->to($user->getEmail())
